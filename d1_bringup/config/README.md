...
| Owner | Fields |
| --- | --- |
| Go2 integration | `deployment.ros_domain_id`, `perception.model_path`, `arm.network_interface`, `arm.expected_ipv4_subnet`, `wrist_camera.driver_location`, camera stream rate/topics, and `site.go2_base_to_arm_base` |
