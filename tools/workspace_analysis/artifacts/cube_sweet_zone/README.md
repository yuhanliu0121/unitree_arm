# Yellow cube sweet-zone coarse scan

- XY grid: `-0.70..0.70 m` x `-0.70..0.70 m`, `0.05 m` step.
- Orientation samples: `0, 10, 20, 30, 40, 50, 60, 70, 80 deg`.
- Conservative points: `101/841`.
- Recommended coarse-grid point: `(0.05, -0.35) m`.
- Grid-derived XY robustness radius: `0.11 m`.
...
- `PLAN_TOP_OBSERVE`: 3744
- `PREGRASP_DESCENT_OR_CARRY`: 1539
- `TARGET_OVERLAPS_GO2_FOOTPRINT`: 1377
