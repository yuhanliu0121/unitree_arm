...
Run with the source bowl blend already open, for example:
  ...
  blender -b objects/bowl/bowl.blend \
    --python tools/blender/create_bowl_grasp_annotation.py \
    -- objects/bowl/bowl_grasp_annotation.blend
...
MESH_DIR = WORKSPACE / "d1_constrained_description_20260728" / "meshes"
DEFAULT_OUTPUT = WORKSPACE / "objects" / "bowl" / "bowl_grasp_annotation.blend"
...
def main() -> None:
    ...
    if bowl is None or bowl.type != "MESH":
        raise RuntimeError("open objects/bowl/bowl.blend before running this script")
    ...
    scene["source_urdf"] = "d1_constrained_description_20260728/urdf/d1_description.urdf"
