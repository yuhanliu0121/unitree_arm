# Bowl sweet-zone coarse scan

- XY grid: `-0.70..0.70 m` x `-0.70..0.70 m`, `0.05 m` step.
- Orientation samples: `0 deg`.
- Conservative points: `114/841`.
- Recommended coarse-grid point: `(0.00, -0.35) m`.
- Grid-derived XY robustness radius: `0.15 m`.
...
- `PLAN_TOP_OBSERVE`: 416
- `PREGRASP_DESCENT_OR_CARRY`: 158
- `TARGET_OVERLAPS_GO2_FOOTPRINT`: 153
