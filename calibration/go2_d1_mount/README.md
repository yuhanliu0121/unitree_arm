...
python calibration/go2_d1_mount/convert_meshes.py
blender --background --factory-startup \
  --python calibration/go2_d1_mount/build_mount_scene.py
```

Open the scene:

```zsh
blender calibration/go2_d1_mount/go2_d1_mount.blend
```
...
```zsh
blender --background calibration/go2_d1_mount/go2_d1_mount.blend \
  --python calibration/go2_d1_mount/read_mount_transform.py
```
